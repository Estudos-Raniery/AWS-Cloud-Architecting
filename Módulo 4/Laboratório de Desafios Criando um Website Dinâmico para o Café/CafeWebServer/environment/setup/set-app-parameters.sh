...
#
publicDNS="xx-xx-xx-xx.us-west-2.compute.amazonaws.com"
...
aws ssm put-parameter --name "/cafe/dbUser" --type "String" --value "admin" --description "Database User Name" --overwrite
